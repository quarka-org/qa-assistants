...
class QAHM_Admin_Page_Behavior_Lp extends QAHM_Admin_Page_Behavior {

	// スラッグ
	const SLUG = QAHM_NAME . '-behavior-lp';
	...
	public function create_html() {
		...
		<div id="<?php echo esc_attr( basename( __FILE__, '.php' ) ); ?>">
			<div class="qa-zero-content">
				<!-- ヘッダー -->
				<?php $this->create_header( esc_html__( 'Landing Pages', 'qa-heatmap-analytics' ) ); ?>
