		...
		'materials' => array(
			...
			'items' => array(
				...
				'properties' => array(
					'name' => array(
						'type' => 'string',
						'description' => 'Material name. Allowed values: \'allpv\', \'gsc\', \'ga4_age_gender\', \'ga4_country\', \'ga4_region\', \'goal_N\', \'click_event\', \'datalayer_event\', \'page_version\', \'wp_posts\' (QA Assistants only), or \'events.{name}\'.',
						'pattern' => '^(allpv|gsc|ga4_age_gender|ga4_country|ga4_region|goal_[1-9]\\d*|click_event|datalayer_event|page_version|wp_posts|events\\.[a-zA-Z0-9_]+)$',
					),
				),
