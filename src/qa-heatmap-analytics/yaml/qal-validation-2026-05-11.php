 ...
 * Edit qal-validation-2026-05-11.yaml and run:
 *   php scripts/build-manifest.php validation 2026-05-11
 *
 * Generated: 2026-08-05 03:07:08
 *
...
return array(
		...
		'materials' => array(
			...
			'items' => array(
				...
				'properties' => array(
					'name' => array(
						'type' => 'string',
						'description' => 'Material name. Allowed values: \'allpv\', \'gsc\', \'ga4_age_gender\', \'ga4_country\', \'ga4_region\', \'goal_N\', \'click_event\', \'datalayer_event\', \'page_version\', \'summary_landingpage\', \'summary_allpage\', \'summary_days_access_detail\', or \'events.{name}\'.',
						'pattern' => '^(allpv|gsc|ga4_age_gender|ga4_country|ga4_region|goal_[1-9]\\d*|click_event|datalayer_event|page_version|summary_landingpage|summary_allpage|summary_days_access_detail|events\\.[a-zA-Z0-9_]+)$',
					),
				),
				...
				'^[a-zA-Z0-9_]+$' => array(
					...
					'properties' => array(
						...
						'keep' => array(
							...
							'items' => array(
								'type' => 'string',
								'pattern' => '^(allpv|gsc|ga4_age_gender|ga4_country|ga4_region|goal_[1-9]\\d*|click_event|datalayer_event|page_version|summary_landingpage|summary_allpage|summary_days_access_detail|events\\.[a-zA-Z0-9_]+)\\.[a-zA-Z0-9_]+$',
							),
							'minItems' => 0,
						),
						'filter' => array(
							'type' => 'object',
							'description' => 'Filter conditions to apply. Keys are plain column names (not qualified). Values are either an array (IN clause) or an object with operator keys. Supported fields depend on material type: allpv (utm_source, utm_medium, utm_campaign, device_type, country_code, depth_position, deep_read, stop_max_sec, stop_max_pos, exit_pos, is_submit, dead_click_image_count, irritation_click_count, scroll_back_count, content_skip_count, exploration_count, prev_page_id, next_page_id, page_type, page_fetch_status, is_article, is_product, is_list, is_form, is_trust_info, is_faq, is_landing, is_search, is_account, is_cart, is_checkout, is_confirm, is_thanks, is_top_page, is_event, is_recipe, is_job, is_video, is_howto, is_qa_forum), gsc (search_type, keyword, ctr, position, position_weighted), ga4_age_gender (age, gender, sessions, active_users), ga4_country (country, sessions, active_users), ga4_region (region, sessions, active_users), goal_x (utm_source, utm_medium, utm_campaign, device_id, is_reject), click_event (is_external, action_id, page_id, to_url, selector, event_sec), page_version (page_id, device_id, version_no, update_date), summary_landingpage (page_id, device_id, utm_source, utm_medium, utm_campaign, is_newuser, second_page, is_QA), summary_allpage (page_id, device_id, utm_source, utm_medium, utm_campaign, is_newuser, is_QA), summary_days_access_detail (device_id, utm_source, utm_medium, utm_campaign, is_newuser, is_QA). Multiple conditions are implicitly AND. Performance hint: prefer filtering by indexed columns (e.g. search_type, keyword, page_id) over computed virtual columns (e.g. ctr, position_weighted) for large datasets.',
	...
	'features' => array(
		...
		'materials_supports_all' => array(
			'enabled' => true,
			'since' => '2026-04-29',
		),
		'calc_join_symmetric' => array(
			'enabled' => true,
			'since' => '2026-05-11',
		),
		'guide_local_source' => array(
			'enabled' => true,
			'since' => '2026-05-11',
		),
		'datalayer_observed_events' => array(
			'enabled' => true,
			'since' => '2026-05-11',
		),
		'material_month_bucket' => array(
			'enabled' => true,
			'since' => '2026-08-05',
		),
		'sample' => array(
