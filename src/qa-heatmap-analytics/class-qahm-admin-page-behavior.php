...
$GLOBALS['qahm_admin_page_behavior'] = new QAHM_Admin_Page_Behavior();

class QAHM_Admin_Page_Behavior extends QAHM_Admin_Page_Dataviewer {

	// スラッグ
	const SLUG = QAHM_NAME . '-behavior';
	...
	public function enqueue_scripts( $hook_suffix ) {
		...
		wp_enqueue_script( QAHM_NAME . '-admin-page-behavior', $js_dir_url . 'admin-page-behavior.js', array( QAHM_NAME . '-admin-page-dataviewer' ), QAHM_PLUGIN_VERSION );
	...
	public function create_html() {
		...
		<div id="<?php echo esc_attr( basename( __FILE__, '.php' ) ); ?>">
			<div class="qa-zero-content">
				<!-- ヘッダー -->
				<?php $this->create_header( esc_html__( 'Behavior', 'qa-heatmap-analytics' ) ); ?>
