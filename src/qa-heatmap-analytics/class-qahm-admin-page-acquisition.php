...
class QAHM_Admin_Page_Acquisition extends QAHM_Admin_Page_Dataviewer {
	...
	public function enqueue_scripts( $hook_suffix ) {
		...
		wp_enqueue_script( QAHM_NAME . '-admin-page-acquisition', $js_dir_url . 'admin-page-acquisition.js', array( QAHM_NAME . '-admin-page-dataviewer', QAHM_NAME . '-echarts-wrapper' ), QAHM_PLUGIN_VERSION );
					...
					<div class="qa-zero-data">
						...
						<div class="qa-zero-graph">
							...
							<div class="qa-zero-graph--large">
								<div id="ch-chart" class="qahm-ec-chart"></div>
							</div>
						</div>
				...
				<div class="qa-zero-data-container">
					<div class="qa-zero-data">
						...
						<div class="qa-zero-graph">
							<div class="qa-zero-graph__title"><?php echo esc_html__( 'Sessions', 'qa-heatmap-analytics' ); ?></div>
							<div class="qa-zero-graph--large">
								<div id="sm-chart" class="qahm-ec-chart"></div>
							</div>
						</div>
